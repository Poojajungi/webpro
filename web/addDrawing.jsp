    ...
    <body>
        ...
        <div class="vh-200 overflow-hidden " style="margin-bottom: 150px;">
            <div class="container border border-light bg-transparent p-4" style="width:50%;border-radius: 15px;margin-top: 150px;">
                <h3 class="text-center mb-4">Owner's Withdrawal Managements</h3>
                <form  method="post">
                    ...
                    <div class="form-group formmain mb-3">
                        <input type="number" class="form-control textbox" name="uid" placeholder="" required readonly value="<%= (ids!=0)?ids:"" %>">
