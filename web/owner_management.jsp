...
<html lang="en">
    ...
    <body class="maindes">
        ...
        <div class=" overflow-hidden vh-200">
            <div class="container border border-light bg-transparent p-4"  style="width:50%;border-radius: 15px;margin-top: 150px;margin-bottom: 190px">
                ...
                <form method="post">
                    ...
                    <div class="form-group formmain mb-3">
                        <input type="number" class="form-control textbox" name="uid" placeholder="" required  value="<%= (idss!=0)?idss:"" %>">
